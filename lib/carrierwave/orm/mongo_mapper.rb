...
MongoMapper::Document.append_extensions(CarrierWave::MongoMapper::Document)
MongoMapper::EmbeddedDocument.append_extensions(CarrierWave::MongoMapper::EmbeddedDocument)
